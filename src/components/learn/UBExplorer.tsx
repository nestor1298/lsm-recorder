    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap items-center gap-3">
        <div className="rounded-lg bg-emerald-50 px-3 py-1.5">
          <span className="text-2xl font-bold text-green-deep">80</span>
          <span className="ml-1.5 text-xs text-green-deep/70">
            ubicaciones
          </span>
        </div>
                ...
                return (
                  <g key={loc.code}>
                    ...
                    <circle
                      ...
                      fill={
                        isSelected ? color : isHovered ? color : `${color}60`
                      }
        ...
        <div className="space-y-3">
          ...
          {displayLoc && (
            <div
              ...
              style={{
                borderColor: REGION_COLORS[displayLoc.region],
                backgroundColor: `${REGION_COLORS[displayLoc.region]}08`,
              }}
            >
              <div className="flex items-center gap-2">
                <span
                  className="h-3 w-3 rounded-full"
                  style={{ backgroundColor: REGION_COLORS[displayLoc.region] }}
                />
              ...
              {displayLoc.latin && (
                <p className="mt-1 text-xs italic text-gray-400">
                  Latín: {displayLoc.latin}
                </p>
              )}
              <div className="mt-2 flex gap-2">
                <span className="rounded bg-paper/80 px-2 py-0.5 text-[10px] font-medium text-gray-500">
                  {REGION_LABELS[displayLoc.region]}
                </span>
                {displayLoc.frequent && (
                  <span className="rounded bg-gold-tint px-2 py-0.5 text-[10px] font-medium text-gold-deep">
                    Alta frecuencia
                  </span>
                )}
              </div>
          ...
          <div className="rounded-xl bg-gray-50 p-3">
            ...
            <p className="text-[11px] leading-relaxed text-gray-500">
              Cada ubicación se codifica con una abreviatura de 2-4 letras
              derivada de su nombre anatómico en latín. Modificadores de
              prefijo: <b className="text-gray-700">Ipsi</b> (mismo lado de la
              mano dominante),
