...
const CONTOUR_MOVEMENTS: {
...
}[] = [
  {
    ...
    description: "Trayectoria directa del punto A al B.",
  },
  {
    type: "ARC",
    label: "Arco",
    path: "M 30,120 Q 100,30 170,120",
    description: "Trayectoria curva en arco.",
  },
  {
    type: "CIRCLE",
    label: "Círculo",
    path: "M 100,40 A 50,50 0 1,1 100,39.9",
    description: "Trayectoria circular.",
  },
  {
    type: "ZIGZAG",
    label: "Zigzag",
    path: "M 30,100 L 60,50 L 100,120 L 140,50 L 170,100",
    description: "Trayectoria angular alternante.",
  },
  {
    type: "SEVEN",
    label: "Siete",
    path: "M 40,50 L 160,50 L 100,140",
    description: "Forma de 7.",
  },
];
...
const LOCAL_MOVEMENTS: {
  ...
  },
  {
    ...
    label: "Raspar",
    icon: "≡",
    description: "Rascado con las yemas",
  },
  {
    type: "NOD",
    label: "Flexionar",
  ...
  },
  {
    ...
    label: "Soltar",
    icon: "↗",
    description: "Dedos se abren desde cerrado",
  },
  {
    type: "FLATTEN",
    label: "Aplanar",
    icon: "▭",
    description: "Dedos se aplanan juntos",
  },
  {
    type: "PROGRESSIVE",
    label: "Progresivo",
  ...
  },
  {
    ...
    label: "Frotar",
    icon: "⇆",
    description: "Movimiento de frotamiento",
  },
];
...
const PLANES: {
...
}[] = [
  {
    ...
    label: "Horizontal",
    color: "#3b82f6",
    description: "Paralelo al suelo",
  },
  {
    type: "VERTICAL",
    label: "Vertical",
    color: "#8b5cf6",
    description: "Paralelo al frente",
  },
  {
    type: "SAGITTAL",
    label: "Sagital",
    color: "#10b981",
    description: "Perpendicular al señante",
  },
  {
    type: "OBLIQUE",
    label: "Oblicuo",
    color: "#f59e0b",
    description: "Plano diagonal",
  },
];
...
export default function MVControls({
  onMovementChange,
  defaultContour,
  defaultLocal,
  defaultPlane,
  ...
  const [activeContour, setActiveContour] = useState<ContourType>(
    (defaultContour as ContourType) ?? "STRAIGHT",
  );
  const [activePlane, setActivePlane] = useState<PlaneType>(
    (defaultPlane as PlaneType) ?? "VERTICAL",
  );
  const [activeLocal, setActiveLocal] = useState<LocalType | null>(
    (defaultLocal as LocalType) ?? null,
  );
  ...
  return (
    <div className={`space-y-4 ${className}`}>
      ...
      <div>
        ...
        {/* Animated SVG */}
        <div className="mb-2 rounded-xl border border-gray-200 bg-gray-50 p-1">
          <svg
            viewBox="0 0 200 150"
            className="w-full"
            style={{ maxHeight: 140 }}
