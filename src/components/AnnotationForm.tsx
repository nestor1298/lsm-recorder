...
const CONTOUR_MOVEMENTS: ContourMovement[] = [
  "STRAIGHT",
  "ARC",
  "CIRCLE",
  "ZIGZAG",
...
const MOVEMENT_PLANES: MovementPlane[] = [
  "HORIZONTAL",
  "VERTICAL",
  "SAGITTAL",
  "OBLIQUE",
];
const PALM_FACINGS: PalmFacing[] = [
  "UP",
  "DOWN",
  "FORWARD",
  "BACK",
...
const FINGER_POINTINGS: FingerPointing[] = [
  "UP",
  "DOWN",
  "FORWARD",
  "BACK",
...
const HEAD_MOVEMENTS: HeadMovement[] = [
  "NONE",
  "NOD",
  "SHAKE",
  "TILT_LEFT",
